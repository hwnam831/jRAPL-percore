...
PERNODECAP=$(($2/4))
python3 ClusterController.py --policy $1 --limit $2 --duration 135 > $3_$1_$2.csv&
...
ssh hwnam831@ow5 "cd /mydata/workspace/jrapl; bash run_hierarchical.sh "$1" 120 "$PERNODECAP" "$3"_"$1"" &
