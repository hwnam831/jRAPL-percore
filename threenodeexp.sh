...
PERNODECAP=$(($2/3))
python3 ClusterController.py --policy $1 --limit $2 --duration 120 > $3_$1_$2.csv&
...
ssh hwnam831@ow4 "cd /mydata/workspace/jrapl; bash run_hierarchical.sh "$1" 90 "$PERNODECAP" "$3"_"$1"" &
