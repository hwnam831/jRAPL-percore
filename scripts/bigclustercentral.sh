...
ssh hwnam831@ow4 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$3" "$2" yolov3 bigcluster1_"$1" high 1" 2> /dev/null &
...
ssh hwnam831@ow5 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$3" "$2" yolov3 bigcluster1_"$1" low 1" 2> /dev/null &
...
ssh hwnam831@ow12 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$3" "$2" yolov3 bigcluster2_"$1" high 2" 2> /dev/null &
...
ssh hwnam831@ow13 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$3" "$2" yolov3 bigcluster2_"$1" low 2" 2> /dev/null &
...
ssh hwnam831@ow20 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$3" "$2" yolov3 bigcluster3_"$1" high 3" 2> /dev/null &
...
ssh hwnam831@ow21 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$3" "$2" yolov3 bigcluster3_"$1" low 3" 2> /dev/null &
...
ssh hwnam831@ow28 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$3" "$2" yolov3 bigcluster4_"$1" high 4" 2> /dev/null &
...
ssh hwnam831@ow29 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$3" "$2" yolov3 bigcluster4_"$1" low 4" 2> /dev/null &
