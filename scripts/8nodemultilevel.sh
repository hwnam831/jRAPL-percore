...
ssh hwnam831@ow4 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$DURATION" "$1" yolov3 bigcluster_multilevel high 3" 2> /dev/null &
...
ssh hwnam831@ow5 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$DURATION" "$1" yolov3 bigcluster_multilevel low 3" 2> /dev/null &
