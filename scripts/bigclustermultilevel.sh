...
ssh hwnam831@ow4 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$2" "$1" yolov3 bigcluster1_multilevel high 1" 2> /dev/null &
...
ssh hwnam831@ow5 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$2" "$1" yolov3 bigcluster1_multilevel low 1" 2> /dev/null &
...
ssh hwnam831@ow12 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$2" "$1" yolov3 bigcluster2_multilevel high 2" 2> /dev/null &
...
ssh hwnam831@ow13 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$2" "$1" yolov3 bigcluster2_multilevel low 2" 2> /dev/null &
...
ssh hwnam831@ow20 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$2" "$1" yolov3 bigcluster3_multilevel high 3" 2> /dev/null &
...
ssh hwnam831@ow21 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$2" "$1" yolov3 bigcluster3_multilevel low 3" 2> /dev/null &
...
ssh hwnam831@ow28 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$2" "$1" yolov3 bigcluster4_multilevel high 4" 2> /dev/null &
...
ssh hwnam831@ow29 "cd /mydata/workspace/jrapl; bash run_centralized.sh "$2" "$1" yolov3 bigcluster4_multilevel low 4" 2> /dev/null &
